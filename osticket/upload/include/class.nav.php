...
class UserNav {
    ...
    function getNavLinks(){
        ...
        if(!$this->navs){
            ...
            $navs = array();
            $user = $this->user;
            $navs['home']=array('desc'=>__('Beranda'),'href'=>'index.php','title'=>'');
            ...
            if ($cfg->getClientRegistrationMode() != 'disabled'
                ...
                $navs['new']=array('desc'=>__('Buat Tiket'),'href'=>'open.php','title'=>'');
            if($user && $user->isValid()) {
                ...
                $navs['status']=array('desc'=>__('Cek Status Tiket'),'href'=>'view.php','title'=>'');
            }
            $this->navs=$navs;
        }
