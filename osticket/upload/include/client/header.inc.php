...
if (osTicket::is_ie())
    $ost->setWarning(__('Sistem ini tidak mendukung browser Internet Explorer.'));
?>>
<head>
    <meta charset="utf-8">
            ...
            <p>
             <?php
                if ($thisclient && is_object($thisclient) && $thisclient->isValid()
                 ...
                 ?>
                <a href="<?php echo ROOT_PATH; ?>profile.php"><?php echo __('Profil'); ?></a> |
                <a href="<?php echo ROOT_PATH; ?>tickets.php"><?php echo sprintf(__('Tiket <b>(%d)</b>'), $thisclient->getNumTickets()); ?></a> -
                <a href="<?php echo $signout_url; ?>"><?php echo __('Keluar'); ?></a>
            <?php
            } elseif($nav) {
                if ($cfg->getClientRegistrationMode() == 'public') { ?>
                    <?php echo __('Pengguna Tamu'); ?> | <?php
                }
                if ($thisclient && $thisclient->isValid() && $thisclient->isGuest()) { ?>
                    <a href="<?php echo $signout_url; ?>"><?php echo __('Keluar'); ?></a><?php
                }
                elseif ($cfg->getClientRegistrationMode() != 'disabled') { ?>
                    <a href="<?php echo $signin_url; ?>"><?php echo __('Masuk'); ?></a>
<?php
                }
            } ?>
            </p>
