<?php
if(!defined('OSTCLIENTINC') || !$faq  || !$faq->isPublished()) die('Akses ditolak');
...
<h1><?php echo __('Frequently Asked Question / Pertanyaan yang sering ditanya');?></h1>
...
<div class="faded"><?php echo sprintf(__('Terakhir diperbarui %s'),
...
<section>
    <strong><?php echo __('Lampiran');?>:</strong>
...
<section>
    <strong><?php echo __('Topik Bantuan'); ?></strong>
