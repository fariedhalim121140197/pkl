<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow justify-content-between">
  <div class="container-fluid">
    <a class="navbar-brand bg-dark col-md-3 col-lg-2 me-1 px-4 fs-6" href="/"><strong>{{ $nama }}</strong></a>
        ...
        <ul class="text-decoration-none m-0">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item py-1" href="/register/showChangePasswordGet">Ganti Password <span data-feather="key"></span></a></li>              
              <li>
