...
@section('container')
    ...
    <div class="table-responsive col-md-10 mb-5">
      <a href="/dashboard/posts/create" class="btn btn-primary mb-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Create">Buat Postingan Baru</a>
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              <th scope="col">No. </th>
              <th scope="col">Judul</th>
              @can ('admin') <th scope="col">Penulis</th> @endcan
