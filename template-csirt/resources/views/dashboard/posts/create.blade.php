...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/posts" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <label for="image" class="form-label">Gambar Posting</label>
            ...
            @can('admin')
              <div class="mb-3">
                ...
                <label for="flexCheckDefault" class="form-check-label">Publikasikan</label>
                @error('published')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <button type="submit" class="btn btn-primary">Buat Posting</button>
        </form>
    </div>
