...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Kategori Posting</h1>
    </div>
    ...
    <div class="table-responsive col-lg-8 mb-4">
      <a href="/dashboard/categories/create" class="btn btn-primary mb-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Create">Buat Kategori Baru</a>
